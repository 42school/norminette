...
explicitly allows it."),
    ...
    "MISSING_RETURN_TYPE": _("Missing return type in function declaration"),
    "NO_NEWLINE_EOF": _("Missing newline at end of file"),
    ...
    "MULTILINE_MACRO": _("Multiline macro is forbidden"),
    ...
    "TYPEOF_FORBIDDEN": _("typeof is forbidden"),
    ...
    "HEADER_PROT_MISSING": _("Header file is not protected from double inclusion"),
