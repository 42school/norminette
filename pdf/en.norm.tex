...
%******************************************************************************%
    \section{Naming}
        ...
        \begin{itemize}
            ...
            \item A structure must have a name, and it must start by
                \texttt{s\_}.

            \item A typedef's name must start by
                \texttt{t\_}.

            \item A union must have a name, and it must start by \texttt{u\_}.

            \item An enum must have a name, and it must start by \texttt{e\_}.
            ...
            \item Using global variables is forbidden and is considered a norm
            error, whether or not they are marked const or static, unless the
            project explicitly allows them.
...
%******************************************************************************%
    \section{Formatting}
            ...
            \item A file must end with a newline.
            ...
            \item Only one instruction or control structure per line is allowed. Eg.: Assignment in
              ...
              a newline is needed at the end of a control structure, ... . This
              reaches inside a return: a comma between its parentheses separates
              two instructions and is forbidden.
            ...
            \item Each C keyword must be followed by a space, except for
              ...
              as well as sizeof. This includes \texttt{break}, \texttt{continue}
              and a \texttt{return} with no value, written \texttt{return ;}.

            \item Control structures (if, while..) must use braces, unless they contain a single
              instruction on a single line. A control structure counts as one
              instruction, so a control structure without braces may hold another
              one, with or without braces of its own.
    ...
    \section{Functions}
        ...
        \begin{itemize}
            ...
            \item A function that doesn't take arguments must be
                ...
                argument. This applies to every argument list the declaration
                holds, including that of a function pointer it takes or
                returns.
    ...
    \section{Macros and Pre-processors}
        ...
        \begin{itemize}
            ...
            \item \textit{(*)} Preprocessor constants (or \#define) you create must be used
                only for literal values and constant expressions built from them.
...
%******************************************************************************%
    \section{Forbidden stuff!}
        ...
        \begin{itemize}
            ...
            \item Implicit type, in a variable declaration as well as in a
              function's return type.

            \item \texttt{typeof}, and its variants \texttt{\_\_typeof\_\_} and
