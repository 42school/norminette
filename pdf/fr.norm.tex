...
%******************************************************************************%
    \section{Conventions de dénomination}
        ...
        \begin{itemize}
            ...
            \item Une structure doit avoir un nom, et il doit commencer par
                \texttt{s\_}.

            \item Un nom de typedef doit commencer par
                \texttt{t\_}.

            \item Une union doit avoir un nom, et il doit commencer par \texttt{u\_}.

            \item Un enum doit avoir un nom, et il doit commencer par \texttt{e\_}.
            ...
            \item L’utilisation de variables globales est interdite et constitue une erreur
                de Norme, qu’elles soient marquées const ou static ou non, sauf si le projet
...
%******************************************************************************%
    \section{Formatage}
            ...
            \begin{itemize}
                ...
                \item Une seule instruction par ligne. Cela vaut à l’intérieur d’un
                \texttt{return} : une virgule entre ses parenthèses sépare deux instructions
                et est interdite.
            ...
            \item Un fichier doit se terminer par un retour à la ligne.
                ...
                \item Chaque mot-clé en C doit être suivi d’un espace, sauf pour ceux
                    ...
                    Cela inclut \texttt{break}, \texttt{continue} et un \texttt{return} sans
                    valeur, écrit \texttt{return ;}.

            \item Les structures de contrôle (if, while..) doivent utiliser des accolades,
                    sauf si elles contiennent une seule instruction sur une seule ligne. Une
                    structure de contrôle compte pour une instruction : une structure de
                    contrôle sans accolades peut donc en contenir une autre, avec ou sans
                    accolades.
    ...
    \section{Fonctions}
        ...
        \begin{itemize}
            ...
            \item Une fonction qui ne prend pas d’argument doit explicitement être prototypée 
                avec le mot \texttt{void} comme argument. Cela vaut pour chaque liste
                d’arguments que porte la déclaration, y compris celle d’un pointeur de
                fonction qu’elle prend ou retourne.
...
%******************************************************************************%
    \section{Macros et Préprocesseur}
        ...
        \begin{itemize}
            ...
            \item Les constantes de préprocesseur (ou \texttt{\#define}) que vous créez ne doivent
                être utilisées que pour des valeurs littérales et des expressions constantes
                bâties sur celles-ci.
...
%******************************************************************************%
    \section{Choses Interdites !}
        ...
        \begin{itemize}
            ...
            \item Le type implicite, aussi bien dans une déclaration de variable que
              comme type de retour d’une fonction.

            \item \texttt{typeof}, et ses variantes \texttt{\_\_typeof\_\_} et
