...
%******************************************************************************%
    \section{Denominação}
        ...
        \begin{itemize}
            ...
            \item Um struct deve ter um nome, e ele deve começar por
                \texttt{s\_}.

            \item O nome de um typedef deve começar por
                \texttt{t\_}.

            \item Um union deve ter um nome, e ele deve começar por \texttt{u\_}.

            \item Um enum deve ter um nome, e ele deve começar por \texttt{e\_}.
           ...
           \item Identificadores, como nomes de variáveis, funções e tipos definidos pelo usuário,
            ...
            \item O uso de variáveis globais é proibido e é considerado um erro de norma,
                sejam elas marcadas como const ou static ou não, a menos que o projeto as
...
%******************************************************************************%
    \section{Formatação}
            ...
            \item Um arquivo deve terminar com uma quebra de linha.
            ...
            uma nova linha é necessária ao final de uma estrutura de controle, ... . Isso alcança o
            interior de um \texttt{return}: uma vírgula entre seus parênteses separa duas
            instruções e é proibida.
            ...
            assim como sizeof. Isso inclui \texttt{break}, \texttt{continue} e um
            \texttt{return} sem valor, escrito \texttt{return ;}.

            \item Estruturas de controle (if, while..) devem usar chaves, a menos que contenham uma única
            instrução em uma única linha. Uma estrutura de controle conta como uma
            instrução, portanto uma estrutura de controle sem chaves pode conter
            outra, com ou sem chaves próprias.
    ...
    \section{Funções}
        ...
        \begin{itemize}
            ...
            \item Uma função que não tem argumentos deve ser
                ...
                argumento. Isso se aplica a cada lista de argumentos que a declaração
                contém, incluindo a de um ponteiro de função que ela receba ou retorne.
...
%******************************************************************************%
    \section{Macros e Pré-processadores}
      ...
      \begin{itemize}
          ...
          \item Constantes de pré-processador (ou \#define) que você criar devem ser usadas
              apenas para valores literais e expressões constantes construídas a partir deles.
...
%******************************************************************************%
    \section{Coisas proibidas!}
        ...
        \begin{itemize}
            ...
            \item Tipo implícito, tanto em uma declaração de variável quanto no tipo de
        retorno de uma função.

        \item \texttt{typeof}, e suas variantes \texttt{\_\_typeof\_\_} e
