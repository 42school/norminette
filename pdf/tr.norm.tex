...
%******************************************************************************%
    \section{İsimlendirme}
        ...
        \begin{itemize}
            ...
            \item Bir struct mutlaka bir isme sahip olmalı ve bu isim \texttt{s\_} ile başlamalıdır.

            \item Bir typedef’in ismi mutlaka \texttt{t\_} ile başlamalıdır

            \item Bir union mutlaka bir isme sahip olmalı ve bu isim \texttt{u\_} ile başlamalıdır.

            \item Bir enum mutlaka bir isme sahip olmalı ve bu isim \texttt{e\_} ile başlamalıdır.
...
akılda kalıcı şekilde isimlendirilmelidir.
            ...
            \item Global değişkenlerin kullanılması, const veya static olarak işaretlenmiş olsalar
da olmasalar da yasaktır ve proje bunlara açıkça izin vermediği sürece norm hatası olarak
değerlendirilir
...
üzerinde yer alabilir. Satır başı bir önceki fonksiyondan sonra gelir.
                ...
                \item Her satırda tek bir talimat yer almalıdır. Bu kural bir \texttt{return} içine de
uzanır: parantezleri arasındaki bir virgül iki talimatı ayırır ve yasaktır.
...
boşluk bırakılmalıdır. Buna \texttt{break}, \texttt{continue} ve değer döndürmeyen
\texttt{return} (\texttt{return ;} şeklinde yazılır) da dahildir.
...
veya atama operatörü ile bir girinti (indentation) eklemeniz gerekecektir. Operatörler satırın başında olmalıdır.
                ...
                \item Kontrol yapılarında (if, while..), tek bir satırda tek bir talimat içerdikleri haller
dışında, ayraç (brace) bulunmalıdır. Bir kontrol yapısı tek bir talimat sayılır, bu nedenle
ayraçsız bir kontrol yapısı, kendi ayraçları olsun ya da olmasın, başka bir kontrol yapısı
içerebilir.

            \item Bir dosya mutlaka yeni satır ile bitmelidir.
...
Bu, bildirimin içerdiği her parametre listesi için geçerlidir; aldığı ya da döndürdüğü bir
fonksiyon işaretçisinin parametre listesi de buna dahildir.
...
%******************************************************************************%
    \section{Makrolar ve Ön İşlemciler}
        ...
        \begin{itemize}
            ...
            \item Yarattığınız ön işlemci sabitleri (veya \#define) yalnızca literal değerler ve
bunlardan oluşturulan sabit ifadeler için kullanılmalıdır.
...
%******************************************************************************%
    \section{Yasaklar!}
        ...
        \begin{itemize}
            ...
            \item Örtük (implicit) tip; hem bir değişken bildiriminde hem de bir fonksiyonun dönüş
tipinde yasaktır.

            \item \texttt{typeof} ve türevleri \texttt{\_\_typeof\_\_} ile
            \texttt{typeof\_unqual}.
