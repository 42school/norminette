...
\begin{itemize}
      ...
      \item Una estructura debe tener un nombre, y debe comenzar con \texttt{s\_}.
      \item El nombre de un typedef debe comenzar con \texttt{t\_}.
      \item Un union debe tener un nombre, y debe comenzar con \texttt{u\_}.
      \item Un enum debe tener un nombre, y debe comenzar con \texttt{e\_}.
      ...
      \item Los objetos (variables, funciones, macros, tipos, archivos o
            ...
            posibles.
      \item El uso de variables globales está prohibido y se considera un error de
            norma, estén marcadas como const o static o no, a menos que el proyecto
            las permita explícitamente.
...
\begin{itemize}
      ...
      \item Cada palabra clave de C debe ir seguida de un espacio, excepto las
            ...
            sizeof. Esto incluye \texttt{break}, \texttt{continue} y un
            \texttt{return} sin valor, escrito \texttt{return ;}.
      ...
      \item Las estructuras de control (if, while, etc...) deben tener llaves,
            salvo que contengan una sola instrucción en una sola línea. Una
            estructura de control cuenta como una instrucción, por lo que una
            estructura de control sin llaves puede contener otra, con o sin
            llaves propias.

            \item Un archivo debe terminar con un salto de línea.

            \item Solo se permite una instrucción por línea. Esto alcanza al
            interior de un \texttt{return}: una coma entre sus paréntesis separa
            dos instrucciones y está prohibida.
...
\begin{itemize}
      ...
      \item Una función que no recibe argumentos debe ser prototipada con la
            palabra ``void'' como argumento. Esto se aplica a cada lista de
            argumentos que contenga la declaración, incluida la de un puntero a
            función que reciba o devuelva.
...
\begin{itemize}
      ...
      \item Las constantes del preprocesador (o \#define) que crees, deben
            usarse solo para valores literales y expresiones constantes
            construidas a partir de ellos.
...
\begin{itemize}
      ...
      \item Tipo implícito, tanto en una declaración de variable como en el tipo
            de retorno de una función.

            \item \texttt{typeof}, y sus variantes \texttt{\_\_typeof\_\_} y
